...
public class Ui {
  ...
  private void editMember() {
    ...
    String newData = " ";
    // if the user chois was email enter the new value and check if the email is unique and isValid.
  ...
  private void deleteBoat() {
    ...
    // compare if the given name is equal to the boat name delete it from the text file.
  ...
  /**
   * loadboats.
   * reads the data file and checks the boat from their typs adds the value correctly
   * creat and object of them and then add that object to list to be used later as an arraylist.
   */
