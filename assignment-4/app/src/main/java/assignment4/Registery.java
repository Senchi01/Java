...
public class Registery {
  ...
  /**
   * read every thing in the data file and if it contains "MEMBER" add the information into.
   * the list of members.
   */
  public void load() {
    String line = "";
   ...
   * loops through every member in the list and if its id matches with user input gets that user.
   */
   ...
   * loops through every member in the list and if its id matches with user input renmove that user.
   */
   ...
   * loops through every member in the list and if its id matches with user input get that member.
   ...
   * loops through every member in the list and if its id matches with user input get the list of -.
